        ...
        >
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-start gap-2">
              <button
                className="h-9 px-4 text-sm font-medium border border-gray-200 rounded-md bg-white hover:bg-gray-50 shadow-sm transition"
                onClick={() => onView?.(item)}
              >
                View
              </button>
              <button
                className="h-9 w-9 flex items-center justify-center rounded-md border border-gray-200 bg-white hover:bg-gray-100 transition"
                onClick={() => onMore?.(item)}
              >
