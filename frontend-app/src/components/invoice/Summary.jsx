...
export const Summary = ({ invoice }) => {
  ...
  // refs for date inputs so clicking icon opens them
  ...
  <div>
    ...
    <div className="relative">
      <input
        ...
        className="pr-8 h-9 w-full border border-input rounded-md text-sm
      ...
      <Calendar
        ...
        className="absolute right-3 top-2.5 w-4 h-4 text-muted-foreground cursor-pointer"
      />
    </div>
  </div>
