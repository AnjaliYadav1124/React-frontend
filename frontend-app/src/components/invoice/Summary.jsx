...
export const Summary = ({ invoice }) => {
  ...
  const flatSelectTrigger =
    "mt-1 h-10 w-full text-sm rounded-md border border-input bg-white " +
    "outline-none focus:outline-none focus:ring-0 focus:ring-offset-0 " +
    "focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 " +
    "focus:border-input";
    ...
    <>
      <div>
        ...
        <Select defaultValue="invoice">
          <SelectTrigger className={flatSelectTrigger}>
      ...
      <div className="mt-4">
        ...
        <Input defaultValue={invoice?.company} className={flatField} />
      </div>

      <div className="mt-4">
        <Label>Invoice / Ref #</Label>
        <Input defaultValue={invoice?.invoiceNumber} className={flatField} />
      </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ref={dateRef}
              type="date"
              defaultValue={invoice?.date || "2025-06-20"}
              className={
                "pr-8 " +
                flatField +
      ...
      <div className="grid grid-cols-2 gap-4 mt-4">
        <div>
          ...
          <Input defaultValue="$1,337.36" className={flatField} />
        </div>
        <div>
