...
export const XeroDestination = () => {
  ...
  const flatField =
    ...
    "outline-none focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-gray-300";
      ...
      <div className="rounded-lg bg-white p-4 shadow-sm border border-gray-200">
        ...
        <div className="relative grid grid-cols-[auto,1fr,auto] grid-rows-[auto,auto,auto] gap-x-3">
          ...
          <img
            ...
            alt="Xero"
            className="w-9 h-9 rounded-full row-span-3"
          />
          ...
          <div className="col-start-2 row-start-2 mt-0.5 flex items-center gap-2 text-[13px] text-gray-600">
            <span className="inline-block h-2.5 w-2.5 rounded-full bg-emerald-500 ring-2 ring-white shadow-[0_0_0_1px_rgba(16,185,129,0.35)]" />
        ...
        {isOpen && (
          <div className="space-y-5 pt-3">
            ...
            <div>
              ...
              <Input defaultValue="Eye Dream" className={flatField + " mt-1"} />
            </div>

            <div>
              <Label className="flex items-center gap-1 text-sm">
                Customer<span className="text-gray-400 text-s">ⓘ</span>
              </Label>
              <Input defaultValue="Eye Dream" className={flatField + " mt-1"} />
            </div>
